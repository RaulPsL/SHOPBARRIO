                                    ...
                                    <div class="main-contenido">
                                        <div class="container izq">
                                            ...
                                            <div class="inputButton venta">
                                                ...
                                                <input type="number" name="venta" id="venta" placeholder="Precio" step="any">                   
                                                <div class="error"></div>
                                            </div>
                                            <div class="inputButton compra">
                                                <label for="">Precio Compra</label>
                                                <input type="number" name="compra" id="compra" placeholder="Costo" step="any">
                                                <div class="error"></div>                   
                                            </div>
                                            <div class="inputButton">
                                                <label for="">Fecha Vencimiento</label>
                                                <input type="date" name="fecha" id="fecha" pattern="\d{4}-\d{2}-\d{2}">
                                                <div class="error"></div> 
                                            </div>
                                            ...
                                            <div class="inputButton cantidad">
                                                ...
                                                <input type="number" name="cantidad" id="cantidad" placeholder="Cantidad" step="any">
                                                <div class="error"></div>
                                            </div>   
                                        </div>                                
                                        <div class="container der">
                                            <div class="inputButton">
                                                ...
                                                <textarea class="descripcion" name="descripcion" id="descripcion" cols="120" rows="4" maxlength="250" placeholder="Escribe una descripcion..."></textarea> 
                                                <div class="error"></div>
                                            </div>
                                            <div class="inputButton">
