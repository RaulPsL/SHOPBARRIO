...
switch ($pagina) {
    ...
    case "modificar_producto.php":
        ...
        <script src="js/script_modificar_producto.js"></script>
        <script src="js/script_menu.js"></script>
        <?php
        break;
    case "login.php":
        ...
        <?php
        break;
    case "registrar_administrador.php":
        ?>
        <link rel="stylesheet" href="css/style_registrar_administrador.css">
        <link rel="stylesheet" href="css/style_registrar_tienda.css">
        <link rel="stylesheet" href="css/style_login.css">
        <?php
        break;
    case "registrar_tienda.php":
        ?>
        <link rel="stylesheet" href="css/style_registrar_administrador.css">
        <link rel="stylesheet" href="css/style_registrar_tienda.css">
        <link rel="stylesheet" href="css/style_login.css">
        <script src="js/script_registrar_tienda.js"></script>
        <?php
        break;
    default:
        ?>
