                        ...
                        <!-- contenedor izquierdo-->
                            <div class="cont_iz" id="cont_iz">
                                <p>Nombre del producto</p>
                                    <input type="text" name="Nombre_prod" class="input Nombre_prod" onclick="restrictions_mod()" id="Nombre_prod" value="<?php echo $valor ['NOMBRE_PRODUCTO'];?>" minlength=2 maxlength=25 required/>
                                        <p class="ocultar" id="nombre_alerta"> *Espacio obligatorio </p>
                                <p>Precio venta</p>
                                    <input type="number" name="Precio_v" class="input Precio_v" id="Precio_v" value= "<?php echo $valor ['PRECIOV_PRODUCTO'];?>" min=0.50 max=999.99 step=0.01 required/>
                                        <p class="ocultar" id="venta_alerta"> *Espacio obligatorio </p>
                                <p>Precio compra</p>
                                    <input type="number" name="Precio_c" class="input Precio_c" id="Precio_c" value= "<?php echo $valor ['PRECIOC_PRODUCTO'];?>" min=0.50 max=999.99 step=0.01 required/>
                            ...
                            <div class="optiones_button">
                                <div>
                                    <a class="Cancelar" id="cancelar" onclick="location.herf='shopbarrio.online/administracion/mostrar_productos.php'">Cancelar</a>
                                </div>
                                <div>
