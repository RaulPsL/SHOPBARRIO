...
<?php include_once 'back/datos_registrar_admin.php'; ?>
                    ...
                    <form action="back/datos_registrar_admin_tienda.php" class="formulario" id="formulario" method="post" onsubmit="return validate_tienda()" novalidate>
                        ...
                        <div class="formulario_admin ">
                            ...
                            <div class="contenedor_general error">
                                    ...
                                    <div class="error-admin" id="error_nombre"></div>
                                </div>
                                <div class="contenedor_general error">
                                ...
                                <div class="Redireccionlogin"> 
                                    ...
                                    <a href="https://shopbarrio.online/sprint2/acceso/login" class="Inicia_sesion">Inicia sesion</a>
                                </div>
                            </div>
                            <div class="btn_field">
                                ...
                                -->
                                <a class="botonsiguiente" id="siguiente">Siguiente</a>
                            </div>  
                        </div>    
