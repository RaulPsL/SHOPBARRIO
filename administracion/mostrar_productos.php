                            ...
                            <tbody class="table-group-divider">
                                <?php                             
                                    foreach ($productos as $producto) { ?>
                                        <tr>
                                            <th scope="row">   
                                                <a <?php $id_prod = $producto['ID_PRODUCTO']?> href="modificar_producto.php?id_producto=<?php echo $id_prod?>"><img class="tarjeta-imagen" src="<?php echo $producto['IMAGEN_PRODUCTO']; ?>" alt="imagen no encontrada" onerror="this.onerror=null;this.src='src/sinimagen.jpg';" style="width: 125px;height: 100px; border-radius: 5px;"></a>
                                            </th>
